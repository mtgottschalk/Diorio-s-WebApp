...
<!-- ****************************** start of changed block ********************** -->
    ...
    <div id="Subs">
        ...
        <br />
	<h3 id="ShowHotButton" onclick="ShowHot()" >         Click to Show Hot Subs</h3>
	<h3 id="ShowColdButton" onclick="ShowCold()" >       Click to Show Cold Subs</h3>
	<h3 id="ShowAllSubsButton" onclick="ShowAllSubs()" > Click to Show All Subs</h3>
    ...
    <form method="post" name="formsubmit"
      ...
      <div class="formsubmit">
        ...
        <textarea cols="60" rows="5" style="font-size: 12pt" name="cart"
        ...
        <textarea cols="60" rows="1" style="font-size:12pt" name="totalprice"
                  readonly="readonly" >
          <?php 
            if(!empty($_SESSION["cart"]["prices"]))
              {
